...
<body>
    ...
    <script src="<c:url value="/resources/angularjs/directives/customDirectives.js"/>"></script>
    <script src="<c:url value="/resources/angularjs/services/customServices.js"/>"></script>
